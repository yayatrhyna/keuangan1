...
<head>
    ...
    <title> FMS | Arthamas Cipta </title>
...
<body class="hold-transition login-page " style="background-image:url('<?php echo base_url(); ?>uploads/systemimgs/bglogin.png'); background-size:cover; position: relative;">
   <br/><br/><br/><br/> <br/>
  ...
  <br/><br/>   
        <h3 class="text-center" style="font-family: cursive;">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:#faffbd;">FMS System </b></a>
        </h3>
        <div class="login-box-body">
            <p class="login-box-msg" style="color: #fffdfde0;font-size: 18px;">Akun diperlukan</p>
            <?php
