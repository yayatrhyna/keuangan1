    			...
    			?>
                    <?php echo form_open('Layout/details',$Contact_attributes); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php
            					$data = array('class'=>'form-control input-lg','type'=>'text','value'=>$company_record[0]->address,'name'=>'address');
            					echo form_input($data);
            				?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php
            					$data = array('class'=>'form-control input-lg','type'=>'text','value'=>$company_record[0]->mobile,'name'=>'mobile');
            					echo form_input($data);
            				?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php
            					$data = array('class'=>'form-control input-lg','type'=>'text','value'=>$company_record[0]->email,'name'=>'email');
            					echo form_input($data);
            				?>
                        </div>
                        <div class="form-group">
