...
--
-- Host: localhost:3306
-- Waktu pembuatan: 16 Agu 2021 pada 07.59
...
--
-- Struktur dari tabel `mp_bank_opening`
--
...
--
-- Dumping data untuk tabel `mp_bank_transaction`
--
...
--
-- Struktur dari tabel `mp_drivers`
--
...
--
-- Dumping data untuk tabel `mp_drivers`
--
...
--
-- Struktur dari tabel `mp_printer`
--
...
--
-- Dumping data untuk tabel `mp_printer`
--
...
--
-- Dumping data untuk tabel `mp_region`
--
...
('12b1f070e5c2988ce43dd68b7ece75cfdbff13e0', '114.124.207.183', 1629075511, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632393037353531313b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
('caf5bfcd76ebafd325ef34ba2f73181133f3a2c0', '114.124.207.183', 1629075511, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632393037353531313b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
--
-- Dumping data untuk tabel `mp_stock`
--
...
--
-- Dumping data untuk tabel `mp_stores`
--
...
--
-- Struktur dari tabel `mp_todolist`
--
...
--
-- Dumping data untuk tabel `mp_town`
--
...
--
-- Struktur dari tabel `mp_vehicle`
--
...
--
-- Dumping data untuk tabel `mp_vehicle`
--
...
--
-- Indeks untuk tabel `mp_bank_opening`
--
...
--
-- Indeks untuk tabel `mp_todolist`
--
...
--
-- AUTO_INCREMENT untuk tabel `mp_bank_opening`
--
ALTER TABLE `mp_bank_opening`
...
--
-- AUTO_INCREMENT untuk tabel `mp_drivers`
--
ALTER TABLE `mp_drivers`
...
--
-- AUTO_INCREMENT untuk tabel `mp_printer`
--
ALTER TABLE `mp_printer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT untuk tabel `mp_region`
--
ALTER TABLE `mp_region`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `mp_stock`
--
ALTER TABLE `mp_stock`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `mp_stores`
--
ALTER TABLE `mp_stores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `mp_supply`
--
ALTER TABLE `mp_supply`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `mp_todolist`
--
ALTER TABLE `mp_todolist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `mp_town`
--
ALTER TABLE `mp_town`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `mp_vehicle`
--
ALTER TABLE `mp_vehicle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Ketidakleluasaan untuk tabel `mp_bank_opening`
--
ALTER TABLE `mp_bank_opening`
  ADD CONSTRAINT `bank_opening_transac` FOREIGN KEY (`bank_id`) REFERENCES `mp_banks` (`id`);

--
-- Ketidakleluasaan untuk tabel `mp_bank_transaction`
--
ALTER TABLE `mp_bank_transaction`
